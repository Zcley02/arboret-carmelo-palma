...
/**
 * Servlet implementation class SLArbolReport
 */
@WebServlet("/SLArbolReport")
public class SLArbolReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SLArbolReport() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.setHeader("Content-Disposition",  "inline; filename=ArbolReporte.pdf");

            ...
            <div class="col-lg-10 mx-auto mt-5">
                <div class="card rounded shadow border-0">
                    ...
                    <div class="card-body bg-white rounded">
                     <%
					 	ArrayList<Region> listarR = new ArrayList<Region>();
					 	DTRegion dtr = new DTRegion();
					 	listarR = dtr.listarRegiones();
		
					 	int idR = Integer.parseInt(id);
					 	
					 	DTDistribucion dt = new DTDistribucion();
					 	Distribucion d = dt.getDistribucion(idR);
					 ...
					 %>
                        ...
                        <form  action="SLEditarDistribucion" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Nombre:</label>
                                <input value="<%=d.getNombre() %>" id="nombre" name="nombre" class="form-control">

                            </div>

                            <div class="form-group">
                                <label>Descripción:</label>
                                <textarea id="descripcion" name="descripcion" class="form-control" rows="3"><%=d.getDescripcion() %></textarea>
                            </div>
                            <div class="form-group">
                                <label>Región:</label>
                                	...
                                	<%
                                		for(Region r: listarR){
                                			if(r.getIdRegion()==d.getIdRegion()){
                                				%>
                                    			<option selected="true" value="<%=r.getIdRegion()%>"><%=r.getNombre()%> </option>

                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered" id="example1">
                                	<div style="text-align:right;"><a class="disabled" href="formfamily.jsp"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;<a class="disabled2" href="editfamily.jsp?id=<%=u.getIdFamilia()%>"><i
                                                    class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                   class="disabled1" href="#" onclick="myDeleteFam(<%=u.getIdFamilia()%>)"><i class="far fa-trash-alt"></i></td>
                                    </tr>
                            		<%
                            			}
                            		%>

            ...
            <div class="col-lg-10 mx-auto mt-5">
                <div class="card rounded shadow border-0">
					...
					%>
                        ...
                        <form  action="SLEditarVision" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="descripcion" name="descripcion" class="form-control" rows="5" minlength="50" maxlength="2500" required><%=in.getVision() %></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                	<img class="rounded img-fluid" alt="nose" src="<%=in.getFotoVision() %>" name="imagen" id="imagen">
                                </div>

            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4" style="color:white">Tipo de Producto</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                
                                <h3>Tabla Tipo Producto</h3>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered" id="example1">
                                	<div style="text-align:right;"><a class="disabled" href="formtypeproduct.jsp"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;<a class="disabled2" href="edittypeproduct.jsp?id=<%=tp.getIdTipoProducto()%>"><i
                                                    class="fas fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                               class="disabled1" href="#" onclick="myDeleteTP(<%=tp.getIdTipoProducto()%>)"><i class="far fa-trash-alt"></i></td>
                                    </tr>
                                    <%
                                		}
                                    %>
       ...
       $(document).ready(function ()
       	    {
       	        ...
       	        if(mensaje == "1")
       	        {
            			alertify.success("Tipo de producto registrado");
       	        }
       	        if(mensaje == "3")
       	        {
            			alertify.success("Tipo de producto actualizado");
       	        }
       	        if(mensaje == "5")
       	        {
       	        ...
       	        if(mensaje == "6")
       	        {
       	            alertify.alert('Alerta','Los elementos de este Tipo de Producto estan siendo utilizados en un registro de Producto');
       	        }
       	        if(mensaje == "error")
       	        {
